...
$(document).ready(function () {
    ...
    function openAccountAppOnUrlChange() {
        if (!$('#cd-my-account').hasClass("speed-in") && (window.location.href.includes('#/account/my-orders') || window.location.href.includes('#/account') || window.location.href.includes('#/account/user-verification'))) openMyAccountPage();
    }
