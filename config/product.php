...
return [
    ...
    'facets'                         => [
        ...
        "editable"      => ['product_category_type', 'product_gender', 'product_age_group', 'product_subtype', 'product_brand', 'product_color_html', 'variant_size_name', 'product_metatag'],
    ],
    ...
    'facet_display_data'             => [
        ...
        'product_att_ecom_sales'   => [
            'name'                   => 'Ecom Sales',
            'item_display_name'      => 'Include sales off',
            'is_singleton'           => true,
            'is_collapsed'           => true,
            'display'                => (isNotProd()) ? true : false,
            'order'                  => 7,
