    ...
    <div class="fixed-bottom d-block d-md-none">
        <div class="row no-gutters">
            ...
            <div class="col-6 text-center">
                <button id="filter" type="button" class="btn btn-lg btn-block btn-primary text-black p-2 text-black text-uppercase w-100"><i class="fa-filter fas text-secondary"></i> Filter</button>
            </div>
        </div>
    </div>