...
<div class="home-slide-item kss-extension" static_element-id="{{$banner['sequence']}}" static_element-display_type="Banner" static_element-type="{{$banner['type']}}" page_slug="home">
