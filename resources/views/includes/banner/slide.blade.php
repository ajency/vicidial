...
<div class="{{$class}} kss-extension" static_element-id="{{$banner['sequence']}}" static_element-display_type="{{$display_type}}" static_element-type="{{$banner['type']}}" page_slug="home">
