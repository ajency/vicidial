...
<div class="container mt-3">
         ...
         <div class="mb-4">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb mb-1 bg-transparent p-0">
                  ...
                  <li class="breadcrumb-item" active><a href="#">Terms-and-condition</a></li>
               </ol>
            </nav>
         </div>
      </div>
   ...
   <div class="row justify-content-center bg-lightgray p-sm-5">
      <div class="col-sm-12 mb-sm-3">
         <h5 class="line-height-5 pt-3 pb-5 fz-sm">
         ...
         <p class="h5 fz-sm font-weight-bold mb-5">
         ...
         <div class="points about mt-5">
            ...
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
         ...
         <div class="points cancellation mt-5" id="cancellation">
            ...
            <h5 class="fz-sm font-weight-bold">
         ...
         <div class="points provisions mt-5">
            ...
            <h5 class="fz-sm font-weight-bold">Force Majeure:</h5>
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
            ...
            <h5 class="fz-sm font-weight-bold mt-3">Notice:</h5>
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
            ...
            <h5 class="fz-sm font-weight-bold mt-3">Assignment:</h5>
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
            ...
            <h5 class="fz-sm font-weight-bold mt-3">Severability:</h5>
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
            ...
            <h5 class="fz-sm font-weight-bold mt-3">Waiver:</h5>
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
            ...
            <h5 class="fz-sm font-weight-bold mt-3">Relationship and Exclusivity:</h5>
            <ol>
               <li class="h5 text-gray line-height-5 fz-sm mt-3">
