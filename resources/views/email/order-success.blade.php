...
<div style="background-color:transparent;">
  ...
  <div style="color:#555555;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">  
    ...
    <p style="margin: 0;font-size: 12px;line-height: 14px;margin-top: 5px;margin-bottom: 5px;padding-top: 10px;/* padding-bottom: 3px; */border-top: 1px solid #ddd;"><span style="font-size: 17px; line-height: 28px;">Total Item Price:&nbsp; &nbsp;₹{{$order_summary['mrp_total']}}</span><br><span style="font-size: 17px; line-height: 28px;">Sub Total:&nbsp; ₹{{$order_summary['sale_price_total']}}</span><br><span style="font-size: 17px; line-height: 28px;">Coupon Discount:&nbsp; - ₹{{$order_summary['cart_discount']}}</span><br></p><p style="margin-top: 4px;font-weight: 600;padding-top: 10px;margin-bottom: 0;border-top: 1px solid #ddd;"><span style="font-size: 18px;line-height: 26px;">Total:&nbsp; &nbsp;₹{{$order_summary['you_pay']}}</span></p></div> 
  </div>
  <!--[if mso]></td></tr></table><![endif]-->
</div>
