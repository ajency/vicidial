...
Route::middleware('auth:api')->post('/rest/v1/user/address/new', 'AddressController@userAddItem');
Route::middleware('auth:api')->get('/rest/v1/user/address/all', 'AddressController@userFetchItems');
