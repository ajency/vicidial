...
Route::post('/rest/v1/save-page-element/new','v1\StaticElementController@callSaveNew'); //working

Route::get('/rest/v1/get-page-element/{seq_no}','v1\StaticElementController@callFetchSeq');
Route::get('/rest/v1/get-page-element','v1\StaticElementController@callFetch'); //not
Route::post('/rest/v1/save-page-element/{seq_no}','v1\StaticElementController@callSave'); //update
