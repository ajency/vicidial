                ...
                if ($discount['exclude_type'] == "category") {
                    ...
                    $expn->value  = [
                        ...
                        "facet"    => [
                            ...
                            "gender"        => ($discount['categ_exclude_2']) ? trim(collect(explode('/', $discount['categ_exclude_1'][1]))->last()) : false,
                            "age_group"     => ($discount['categ_exclude_3']) ? trim(collect(explode('/', $discount['categ_exclude_1'][1]))->last()) : false,
                            "subtype"       => ($discount['categ_exclude_4']) ? trim(collect(explode('/', $discount['categ_exclude_1'][1]))->last()) : false,
                        ],
