...
class OrderController extends Controller
{
    ...
    {
        $request->validate(['subOrderId' => 'required', 'state' => 'required', 'shipment_status' => 'required', 'is_invoiced' => 'required', 'external_id' => 'required']);
        $params = $request->all();
        OrderLineStatus::dispatch($params["subOrderId"], $params["state"], $params["shipment_status"], $params["is_invoiced"], $params["external_id"])->onQueue('odoo_order');
    }
