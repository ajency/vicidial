...
class ProductController extends Controller
{
    ...
    public function SingleProductApi(Request $request){
        ...
        $apiResponse = Cache::remember('single-product-'.$slug,60*12, function()use($slug){
            ...
            $apiResponse = $singleProduct->generateSinglePageData(['attributes','facets','variants','images','is_sellable','color_variants','breadcrumbs','related_products','meta','sizechart','blogs']);
            return $apiResponse;
        });
